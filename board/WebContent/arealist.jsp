...
<section id="team" class="pb-5" style="border: 1px solid #FFFFFF; height: auto; width:100%   "  >
    ...
    <div class="side-menu-container"  >
        <div class="nav navbar-nav" style="font-size:1.2em; margin:50px 10px 30px 20px; text-align:left;  " >
            ...
            <!-- Dropdown-->
            <div class="panel panel-default" id="dropdown">
                <a data-toggle="collapse" href="#" style="text-decoration:none" >
                    <span class="glyphicon glyphicon-user"></span> <font color="white" > 지역별 보기 &nbsp  </font> </a>
                ...
                <div id="dropdown-lvl2" class="panel-collapse collapse">
  				...
  				<div class="col-md-9" name="top">
  					<div class="control-box p-3 main-content">
  					<div>
  					<div class="container">
					<div class="row"  >
  					<h2 style="padding:10px 0px 10px 20px;" > 지역별 보기 : ${areas}</h2>
  					</div>
