...
<body>
	...
	<table class="table table-striped table-bordered table-hover" style="text-align:center">
		...
		<tr>
			<td style="text-align:center" colspan="4" > <img src="./img/${article.imgpath}" alt="${article.imgpath}"></td>		
		</tr>
		<tr>
			<th>공연/전시 제목</th>
	...
	<form id="inform" action ="/board/reply.do" method="post" name="writeform" >
		...
		<tr >
			<th>제목</th>
			<td colspan='3'style="text-align:left"><input type="text" name="title" cols="90"  placeholder="제목을 입력하세요" form="inform"></td></th>
